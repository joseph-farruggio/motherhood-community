    ...
    <body <?php body_class('bg-white text-gray-900 antialiased'); ?>>
        ...
        <div id="page" class="min-h-screen flex flex-col">
            ...
            <header
                    ...
                    <div class="flex items-center gap-5 lg:block">
                        ...
                        <div class="hidden lg:flex lg:items-center lg:justify-end lg:gap-5 lg:mb-6">
                            <a href="https://www.instagram.com/motherhoodcommunityofficial/">
                                <svg role="img" class="h-6 text-[#020202]/80 hover:text-[#020202]" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex items-center justify-center gap-10 mb-6 bg-[#B9AAAA]/10 px-2 py-4 lg:hidden">
                    <a href="https://www.instagram.com/motherhoodcommunityofficial/">
