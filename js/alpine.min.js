...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  module_default.store("menuOpen", false);
  module_default.store("searchOpen", false);
  module_default.data("social", () => ({
    share: (url) => {
  ...
  module_default.data("navigatorShare", (title, text, url) => ({
    shareData: {
      title,
      text,
      url
  ...
  module_default.data("featuredPosts", (data2) => ({
    posts: data2,
    active: 0,
    prev() {
  ...
  module_default.magic("clipboard", () => (subject) => {
